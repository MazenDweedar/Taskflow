              ...
              return (
                <li key={p.id} className="group relative">
                  ...
                  <button
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 opacity-100 md:opacity-0 group-hover:opacity-100 text-[#EF4444] md:text-text-secondary md:hover:text-[#EF4444] transition-all p-1.5 rounded-lg hover:bg-[#EF4444]/10"
